...
$string['import_properties'] = 'Import Properties';
$string['import_maac_sheet'] = 'Import MAAC sheet';
$string['import_maac_sheet_desc'] = 'Allow Managers to import MAAC custom-column data from XLSX or CSV files.';
$string['import_maac'] = 'Import MAAC';
$string['module_tracker'] = 'Module Tracker';
$string['module_tracker_configuration'] = 'Module Tracker Categories';
$string['module_tracker_assignment_aliases'] = 'Assignment category aliases';
$string['module_tracker_test_aliases'] = 'Test category aliases';
$string['module_tracker_project_aliases'] = 'Project category aliases';
$string['module_tracker_category_aliases_desc'] = 'Comma-separated Gradebook category names or phrases to include in this Module Tracker tab.';
...
$string['messageprovider:ticket_raised'] = 'Ticket raised';
$string['messageprovider:ticket_update'] = 'Ticket updated';
